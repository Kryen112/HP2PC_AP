...
// subclass's MarkerTier defaultprop, generated by gen_apworld), translates
// bean tiers to counts, and otherwise passes the raw item name through.
// `Sender` is empty when the IPC payload had no sender field (older sidecar
...
function ApplyGrant(string Body)
{
    ...
    // Body is `<itemname>` (legacy) or `<itemname>|<sender>` (sidecar
